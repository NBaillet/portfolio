<template>
    <div class="bg-stone-900 text-white">
        ...
        <div class="float-right">
            <div class="inline-block p-2 text-lg">
                <a href="#about" class="inline ml-2 p-2 rounded-sm no-underline
                                      text-green-500 bg-stone-700 hover:bg-red-300">About</a>
                <a href="#projects" class="inline ml-2 p-2 rounded-sm no-underline
                                         text-green-500 bg-stone-700 hover:bg-red-300">Projects</a>
            </div>
            <button class="inline-block p-2 text-lg bg-red-700 border-2">Contact</button>
        </div>    
    </div>
</template>
